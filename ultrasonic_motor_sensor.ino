...
void loop() {
  ...
  // 예)  Serial.println("직진");
  if (IR_L_data == 0 and IR_M_data == 1 and IR_R_data == 0 and distance>20) {
    Serial.println("직진");
    forward();


  }
  else if (IR_L_data == 1 and IR_M_data == 0 and IR_R_data == 0 and distance>20) {
    Serial.println("좌회전 ");
    left();
  }
  else if (IR_L_data == 0 and IR_M_data == 0 and IR_R_data == 1 and distance>20) {
    Serial.println("우회전");
    right();
  }
  else if (IR_L_data == 1  and IR_R_data == 1 and distance<20) {
    Serial.println("정지");
    stop();
  }
}
